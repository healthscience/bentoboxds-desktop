describe('Graph Tests', () => {
  ...
  it('should click on Graph button and verify the modal and content', () => {
      ...
      // Step 2: Click on the Graph button
      cy.get('#graph-button').click() // Adjusted selector for Graph

      // Step 3: Verify that the Graph modal is presented
